...
function b(n) {
  const e = n.replace("#", "");
  if (e.length === 3) {
    const r = parseInt(e[0] + e[0], 16), a = parseInt(e[1] + e[1], 16), t = parseInt(e[2] + e[2], 16);
    return [r, a, t];
  }
  if (e.length === 6) {
    const r = parseInt(e.substring(0, 2), 16), a = parseInt(e.substring(2, 4), 16), t = parseInt(e.substring(4, 6), 16);
    return [r, a, t];
  }
  return [0, 0, 0];
}
function s(n, e, r) {
  ...
  const a = Math.round(n / 255 * 5), t = Math.round(e / 255 * 5), o = Math.round(r / 255 * 5);
  return 16 + 36 * a + 6 * t + o;
}
export {
  i as ANSI_COLORS,
  d as getColor,
